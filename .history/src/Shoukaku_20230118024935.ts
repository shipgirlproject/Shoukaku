...
export declare interface Shoukaku {
     ...
     * @eventProperty
     */
    on(event: 'reconnecting', listener: (name: string, tries: number, reconnectInterval: number) => void): this;
    /**
    ...
    once(event: 'reconnecting', listener: (name: string, info: string, tries: number, reconnectInterval: number) => void): this;
    ...
    off(event: 'reconnecting', listener: (name: string, info: string, tries: number, reconnectInterval: number) => void): this;
